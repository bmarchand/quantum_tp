...
prog.apply(ham_x(theta).ctrl(), q) # .ctrl() can be used on any 1-qubit gate to get a 2-qubit controlled version
...
for coeffs in ham_data:
    ...
    E = 2*np.pi*phi_perfect/dt -shift
    E_trotter_4 = 2*np.pi*phi_trotter_4/dt -shift
    E_trotter_10 = 2*np.pi*phi_trotter_10/dt -shift
    print("R", coeffs['R'])
    Rs.append(coeffs['R'])
