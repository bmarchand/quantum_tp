...
# - $ZZ = CNOT . I\otimes Z . CNOT$\
# $\implies U_{ZZ}(dt) = CNOT . e^{-i dt I\otimes Z} . CNOT = CNOT . I\otimes RZ(2 dt) . CNOT$
...
# - $XX = CNOT . X\otimes I . CNOT$ \
# $\implies U_{XX}(dt) = CNOT . e^{-i dt X\otimes I} . CNOT = CNOT . RX(2 dt)\otimes I . CNOT$
# - $YX = CNOT . Y\otimes I . CNOT$\
# $\implies U_{YX}(dt) = CNOT . e^{-i dt Y\otimes I} . CNOT = CNOT . RY(2 dt)\otimes I . CNOT$
...
# ### Comment:
# The shape of the perfect curve seems to match the results obtained in figure 3 of https://arxiv.org/abs/1512.06860. We verify that for higher trotter numbers the results obtained with the "Trotterized version" are closer to the one obtained with the "Ideal version" that exponentiates the Hamiltonian.
