...
def U_XX(dt):
    ...
    # On a X x X = CNOT(0,1) . X x I . CNOT(0,1) , avec "x" le produit de Kronecker et "." le produit matriciel.
...
def U_YY(dt):
    ...
    # On montre que Y x Y = S . Y x X . Sdag , avec "x" le produit de Kronecker et "." le produit matriciel.
