...
"""
    ...
    for i in range(p): 
      ...
      qroutine.apply(U_II((ham_coeffs[keys[0]]+shift)*dt/p),0,1)
      qroutine.apply(U_ZI(ham_coeffs[keys[1]]*dt/p),0,1)
      qroutine.apply(U_IZ(ham_coeffs[keys[2]]*dt/p),0,1)
      qroutine.apply(U_ZZ(ham_coeffs[keys[3]]*dt/p),0,1)
      qroutine.apply(U_XX(ham_coeffs[keys[4]]*dt/p),0,1)
      qroutine.apply(U_YY(ham_coeffs[keys[5]]*dt/p),0,1)
